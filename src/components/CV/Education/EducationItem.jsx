...
export default function EducationItem({isVisible, schoolName, graduationDate, qualification, schoolLocation}) {
    return (
        <div>
            <div className={`${styles.flexContainer} ${isVisible && styles.hidden}`}>
